...
export const HOME_WELCOME_SLIDES = [
  {
    id: "welcome",
    title: "Football keeps the score. We keep the receipts.",
    subtitle: "Premier League receipts",
    body: "Make your calls. Challenge the pundits. Turn what happens into content.",
    accent: "brand" as const,
    backgroundImage: "/images/welcome-hero-panel.png",
    highlights: ["Make a pick", "Challenge the pundits", "Open Studio"],
    stickerImage: "/reactions/locked-in.svg",
  },
] as const;
