  ...
  return (
    ...
    >
      <AnimatePresence mode="popLayout">
        {/* Step 1 — confirmation flash (stays on screen) */}
        <motion.div
          key="flash"
        ...
        {/* Step 2 — reaction card (delayed entrance, stays visible) */}
        <motion.div
          key="reaction"
        ...
        >
          {!reduceMotion && (
            <motion.div
              ...
              initial={{ opacity: 0 }}
              animate={{ opacity: [0, 0.7, 0.25, 0.6, 0.2, 0] }}
              transition={{
                duration: celebrationTiming.glowPulseDuration,
                times: [0, 0.15, 0.35, 0.55, 0.75, 1],
                repeat: celebrationTiming.glowPulseCycles - 1,
                delay: celebrationTiming.cardDelay,
              }}
              aria-hidden
            />
        ...
        {/* Step 3 — share button fades in last */}
        <motion.div
          key="share"
