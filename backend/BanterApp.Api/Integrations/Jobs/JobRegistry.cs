...
public static class JobRegistry
{
    ...
    [
        ...
        new("gif.query.refresh", "gif-query-refresh", "GIF Query Refresh", "Seed the first-party GIF library and refresh football GIF search phrases (not Giphy files).", "22 */3 * * *", true, true),
