...
builder.Services.AddScoped<ReceiptSettlementService>();
...
builder.Services.AddScoped<PunditFollowService>();
builder.Services.AddScoped<StudioComparisonService>();
builder.Services.AddScoped<StudioStoryService>();
builder.Services.AddScoped<StudioPackService>();
builder.Services.AddScoped<PunditMatchPredictionSync>();
...
builder.Services.AddScoped<ProductMetricService>();
