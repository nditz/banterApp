...
namespace BanterApp.Api.Data.Migrations
{
    ...
    [Migration("20260702124532_AddFootballReferenceData")]
    partial class AddFootballReferenceData
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BanterApp.Api.Data.Entities.Country", b =>
                {
                    ...
                    b.HasIndex("ExternalProvider", "ExternalId")
                        .IsUnique()
                        .HasFilter("\"external_provider\" IS NOT NULL AND \"external_id\" IS NOT NULL");
