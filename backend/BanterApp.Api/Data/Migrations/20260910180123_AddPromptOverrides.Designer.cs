...
namespace BanterApp.Api.Data.Migrations
{
    ...
    [Migration("20260910180123_AddPromptOverrides")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BanterApp.Api.Data.Entities.BanterContentHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("CaptionHash")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
                    ...
                    b.Property<string>("MemeTemplateId")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)");
                    ...
                    b.HasIndex("MemeTemplateId", "UsedAtUtc");

                    b.HasIndex("Provider", "ProviderContentId");

                    b.HasIndex("ScenarioType", "UsedAtUtc");

                    b.HasIndex("TeamId", "UsedAtUtc");

                    b.HasIndex("UserId", "UsedAtUtc");

                    b.ToTable("banter_content_history", (string)null);
                });
            ...
            modelBuilder.Entity("BanterApp.Api.Data.Entities.GifAsset", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("IsActive", "Mood");

                    b.ToTable("gif_assets", (string)null);
                });

            modelBuilder.Entity("BanterApp.Api.Data.Entities.GifSearchQuery", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("IsFootballRelated")
                        .HasColumnType("boolean");
                    ...
                    b.HasIndex("IsActive", "IsFootballRelated", "LastSeenAtUtc");

                    b.ToTable("gif_search_queries", (string)null);
                });
            ...
            modelBuilder.Entity("BanterApp.Api.Data.Entities.PredictionReceipt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("PunditTakesJson")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("StoryTypesJson")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasIndex("PredictionId", "ResultHash")
                        .IsUnique();

                    b.ToTable("prediction_receipts", null, t =>
                        {
                            t.HasCheckConstraint("CK_prediction_receipts_owner", "(\"UserId\" IS NOT NULL AND \"AnonymousUserId\" IS NULL) OR (\"UserId\" IS NULL AND \"AnonymousUserId\" IS NOT NULL)");
                        });
                });

            modelBuilder.Entity("BanterApp.Api.Data.Entities.PromptOverride", b =>
                {
            ...
            modelBuilder.Entity("BanterApp.Api.Data.Entities.ReceiptStoryCandidate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ReceiptId", "Rank");

                    b.ToTable("receipt_story_candidates", (string)null);
                });
            ...
            modelBuilder.Entity("BanterApp.Api.Data.Entities.PredictionReceipt", b =>
                {
                    ...
                    b.HasOne("BanterApp.Api.Data.Entities.Prediction", "Prediction")
                        .WithMany("Receipts")
            ...
            modelBuilder.Entity("BanterApp.Api.Data.Entities.ReceiptStoryCandidate", b =>
                {
                    b.HasOne("BanterApp.Api.Data.Entities.PredictionReceipt", "Receipt")
                        .WithMany("StoryCandidates")
